# create 1 scenario outline and create scenario or scenario outlines for page
# https://kristinek.github.io/site/tasks/list_of_people.html
# or
...
Feature: Task2
  ...
  Scenario: Edit a person
    ...
    And I see edit form
    And I change name: "Simona"
    And I change surname: "Duo"
    And I click edit
    Then I am redirected to home page
